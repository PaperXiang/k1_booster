...
Brain::Brain() : rclcpp::Node("brain_node")
{
    ...
    declare_parameter<bool>("strategy.enable_stable_kick", true);
    declare_parameter<bool>("strategy.limit_near_ball_speed", true);
    declare_parameter<double>("strategy.near_ball_speed_limit", 0.75);
    declare_parameter<double>("strategy.near_ball_range", 1.3);
